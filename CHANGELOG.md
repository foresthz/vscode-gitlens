...
- Moves the _Open Working File_ command (`gitlens.openWorkingFile`) to the right of the _Compare File with _ Revision\* commands in the editor toolbar
...
- Fixes issue where _Open _ in Remote\* commands are sometimes missing
...
- Fixes issue with _Open _ in Remote\* commands with nested repositories and non-git workspace root folder
